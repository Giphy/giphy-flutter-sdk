...
| enableEdgeToEdge | Enables Edge-to-Edge UI rendering in Android. To fully enable this, additional updates are required in the `styles.xml` file. See the [Flutter documentation](https://docs.flutter.dev/release/breaking-changes/default-systemuimode-edge-to-edge) for guidance on required updates. | `bool` | `false` | ✅ Android <br/> ❌ iOS |
