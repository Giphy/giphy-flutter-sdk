...
class GiphyTheme {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'handleBarColor': handleBarColor?.toARGB32(),
      'emojiDrawerGradientBottomColor': emojiDrawerGradientBottomColor?.toARGB32(),
      'emojiDrawerGradientTopColor': emojiDrawerGradientTopColor?.toARGB32(),
      'emojiDrawerScrollIndicatorStyle': emojiDrawerScrollIndicatorStyle != null
          ...
          : null,
      'emojiDrawerSeparatorColor': emojiDrawerSeparatorColor?.toARGB32(),
      'searchBackButtonColor': searchBackButtonColor?.toARGB32(),
      'searchBarBackgroundColor': searchBarBackgroundColor?.toARGB32(),
      'searchBarCornerRadius': searchBarCornerRadius,
      'searchBarPadding': searchBarPadding,
      'searchPlaceholderTextColor': searchPlaceholderTextColor?.toARGB32(),
      'searchTextColor': searchTextColor?.toARGB32(),
      'suggestionCellBackgroundColor': suggestionCellBackgroundColor?.toARGB32(),
      'suggestionCellTextColor': suggestionCellTextColor?.toARGB32(),
      'tabBarBackgroundAlpha': tabBarBackgroundAlpha,
      'tabBarSwitchDefaultColor': tabBarSwitchDefaultColor?.toARGB32(),
      'tabBarSwitchSelectedColor': tabBarSwitchSelectedColor?.toARGB32(),
      'avatarPlaceholderColor': avatarPlaceholderColor?.toARGB32(),
      'confirmationBackButtonColor': confirmationBackButtonColor?.toARGB32(),
      'confirmationSelectButtonColor': confirmationSelectButtonColor?.toARGB32(),
      'confirmationSelectButtonTextColor':
          confirmationSelectButtonTextColor?.toARGB32(),
      'confirmationViewOnGiphyColor': confirmationViewOnGiphyColor?.toARGB32(),
      'usernameColor': usernameColor?.toARGB32(),
      'backgroundColorForLoadingCells': backgroundColorForLoadingCells?.toARGB32(),
      'cellCornerRadius': cellCornerRadius,
      'fixedSizeCells': fixedSizeCells,
      'stickerBackgroundColor': stickerBackgroundColor?.toARGB32(),
      'keyboardAppearance': keyboardAppearance != null
          ? GiphyKeyboardAppearanceExtension.toStringValue(keyboardAppearance!)
          : null,
      'backgroundColor': backgroundColor?.toARGB32(),
      'defaultTextColor': defaultTextColor?.toARGB32(),
      'dialogOverlayBackgroundColor': dialogOverlayBackgroundColor?.toARGB32(),
      'retryButtonBackgroundColor': retryButtonBackgroundColor?.toARGB32(),
      'retryButtonTextColor': retryButtonTextColor?.toARGB32(),
    };
  }
}
